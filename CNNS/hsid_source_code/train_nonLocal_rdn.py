...
from model_non_local_rdn import HSIRDNWithNonLocal
...
def train_model_residual_lowlight_rdn():
    ...
    save_model_path = './checkpoints/hsirnd_nonlocal'
    if not os.path.exists(save_model_path):
        os.mkdir(save_model_path)

    #创建模型
    net = HSIRDNWithNonLocal(K)
    init_params(net)
    ...
    for epoch in range(start_epoch, num_epoch+1):
        ...
        }, f"{save_model_path}/hsid_rdn_non_local_l2_loss_patchsize32_{epoch}.pth")
        ...
        if psnr > best_psnr:
            ...
            torch.save({
                ...
                'gen': net.state_dict(),
                'gen_opt': hsid_optimizer.state_dict(),
            }, f"{save_model_path}/hsid_rdn_nonLocal_l2_loss_patchsize32_best.pth")
