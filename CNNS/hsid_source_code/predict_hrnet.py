...
def predict_lowlight_residual_hrnet():
    ...
    hsid = hsid.to(DEVICE)
    hsid.load_state_dict(torch.load('./checkpoints/hrnet_patchsize64_best.pth', map_location='cuda:0')['gen'])
...
if __name__ == '__main__':
    predict_lowlight_residual_hrnet()