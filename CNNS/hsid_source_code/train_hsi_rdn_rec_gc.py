...
from model_rdn import HSIRDN,HSIRDNMOD,HSIRDNSE,HSIRDN_REC_GC
import model_utils
import dir_utils
...
def train_model_residual_lowlight_rdn():
    ...
    save_model_path = './checkpoints/hsirnd_rec_gc'
    ...
    for epoch in range(start_epoch, num_epoch+1):
        ...
        }, f"{save_model_path}/hsid_rdn_rec_gc_l1_loss_600epoch_patchsize32_{epoch}.pth")
        ...
        if psnr > best_psnr:
            ...
            torch.save({
                ...
                'gen': net.state_dict(),
                'gen_opt': hsid_optimizer.state_dict(),
            }, f"{save_model_path}/hsid_rdn_rec_gc_l1_loss_600epoch_patchsize32_best.pth")
