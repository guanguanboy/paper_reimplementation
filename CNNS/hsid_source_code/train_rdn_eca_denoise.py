...
def train_model_residual_lowlight_rdn():
    ...
    save_model_path = './checkpoints/hsirnd_denoise_l1loss_sigma75'
    ...
    for epoch in range(start_epoch, num_epoch+1):
        ...
        """
        #加载数据
        test_data_dir = './data/denoise/test/level75'
        ...
        for batch_idx, (noisy, label) in enumerate(test_dataloader):
            ...
            with torch.no_grad():
                for i in range(band_num): #遍历每个band去处理
                    ...
                    residual = net(current_noisy_band, adj_spectral_bands_unsqueezed)
