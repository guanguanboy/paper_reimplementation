...
def predict_lowlight_hsid_origin():
    ...
    file_name = '007_2_2021-01-19_044'

    #加载测试label数据
    mat_src_path = './data/lowlight_origin_outdoor_standard/unused/15ms/' + file_name + '.mat'
    test_label_hsi = scio.loadmat(mat_src_path)['label_normalized_hsi']

    #加载测试数据
    batch_size = 1
    #test_data_dir = './data/test_lowlight/cuk12/'
    test_data_dir = './data/test_lowli_outdoor_k12/unused/' + file_name + '/'
    ...
    #指定结果输出路径
    test_result_output_path = './data/testresult/outdoor_standard/'
