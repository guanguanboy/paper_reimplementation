...
save_path = './data/test_lowli_outdoor_k12_reversed/'
...
noisy_mat_dir = '/mnt/liguanlin/codes/papercodes/paper_reimplementation/CNNS/HSID/data/lowlight_origin_outdoor_standard/test/1ms'
label_mat_dir = '/mnt/liguanlin/codes/papercodes/paper_reimplementation/CNNS/HSID/data/lowlight_origin_outdoor_standard/test/15ms'
...
for i in range(mat_count):
    ...
    gen_test_patches(label, noisy, channels, mat_name[:-4])# 这里的-4表示去掉.mat