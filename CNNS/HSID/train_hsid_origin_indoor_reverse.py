...
def train_model_residual_lowlight():
    ...
    train_set = HsiCubicTrainDataset('./data/train_lowlight_patchsize64_k12_reverse/')
    ...
    #加载测试数据
    batch_size = 1
    test_data_dir = './data/test_lowlight/cuk12_reverse/'
    ...
    save_model_path = './checkpoints/hsid_origin_patchsize64_reverse'
    ...
    for epoch in range(start_epoch, num_epoch+1):
        ...
        for batch_idx, (noisy, cubic, label) in enumerate(train_loader):
            ...
            loss = loss_function_mse(residual, noisy - label)
