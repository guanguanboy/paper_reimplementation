...
def train_model_residual_lowlight_twostage_unet():
    ...
    #创建模型
    net = HSIDDenseNetTwoStageUNet(K)
    init_params(net)
    ...
    for epoch in range(start_epoch, num_epoch+1):
        ...
        }, f"checkpoints/two_stage_hsid_unet_{epoch}.pth")
        ...
        if psnr > best_psnr:
            ...
            torch.save({
                ...
                'gen': net.state_dict(),
                'gen_opt': hsid_optimizer.state_dict(),
            }, f"checkpoints/two_stage_hsid_unet_best.pth")
...
def train_model_residual_lowlight_twostage_gan_best():
    ...
    for epoch in range(start_epoch, num_epoch+1):
        ...
        }, f"checkpoints/two_stage_hsid_unet_gan_{epoch}.pth")
        ...
        if psnr > best_psnr:
            ...
            torch.save({
                ...
                'disc': disc.state_dict(),
                'disc_opt': disc_opt.state_dict()                  
            }, f"checkpoints/two_stage_hsid_unet_gan_best.pth")
